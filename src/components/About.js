                  ...
                  <li key={person.name} className="sm:py-8">
                    <div className="space-y-4 sm:grid sm:grid-cols-3 sm:items-start sm:gap-6 sm:space-y-0">
                      <div className="aspect-w-3 aspect-h-2 sm:aspect-w-3 sm:aspect-h-4">
                        <img className="object-cover shadow-lg rounded-lg" src={profile} alt="Image of Charles" />
                      </div>
                      <div className="sm:col-span-2">
                        <div className="space-y-4">
                          ...
                          <ul role="list" className="flex space-x-5">
                            <li>
                              <a href={person.twitterUrl} target="_blank" className="text-gray-600 hover:text-gray-400">
                            ...
                            <li>
                              <a href={person.linkedinUrl} target="_blank" className="text-gray-600 hover:text-gray-400">
